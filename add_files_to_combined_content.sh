...
#%#
#%
for i in index.php config.php.1 includes/db.php views/home.php views/layout/header.php views/layout/footer.php views/cart.php controllers/BaseController.php models/User.php models/Quiz.php ; do (echo -e "# $i  \n\`\`\`php" ; cat $i ; echo -e "\n\`\`\`\n" ) ; done | tee content_of_code_files_1.md
...
for i in views/account/dashboard.php views/account/order_details.php views/account/orders.php controllers/QuizController.php views/admin/products.php views/admin/product_form.php views/admin/quiz_analytics.php ; do (echo -e "# $i  \n\`\`\`php" ; cat $i ; echo -e "\n\`\`\`\n" ) ; done | tee content_of_code_files_6.md 

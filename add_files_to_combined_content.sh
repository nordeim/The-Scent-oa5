...
for i in views/account/dashboard.php views/account/order_details.php views/account/orders.php controllers/QuizController.php views/admin/products.php views/admin/product_form.php views/admin/quiz_analytics.php stripe_test_v4.php ; do (echo -e "# $i  \n\`\`\`php" ; cat $i ; echo -e "\n\`\`\`\n" ) ; done | tee content_of_code_files_6.md 
